...
\begin{figure}[H]
    ...
    \caption{Dieta z manj maščpbami, omejitvijo mase in dodatnimi omejitvami}
    \label{fig:fat-add}
\end{figure}
...
\subsubsection{Čim cenejši obrok, ki zadosti osnovnim potrebam}
Poiščimo čim cenejši obrok, ki zadostuje osnovnim potrebam kar se tiče hranilnih 
snovi.
